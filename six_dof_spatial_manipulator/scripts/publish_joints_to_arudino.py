...
def cb(msg):
    x=Floats()
    x.data.append(30.0+(math.degrees(msg.position[0])))
    x.data.append(120.0+(math.degrees(msg.position[1])))
    x.data.append(80.0+(math.degrees(msg.position[2])))
    x.data.append(100.0+(math.degrees(msg.position[3])))
    x.data.append(10.0+(math.degrees(msg.position[4])))
