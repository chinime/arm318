...
def processFeedback(feedback):
    ...
    if(feedback.event_type == InteractiveMarkerFeedback.MENU_SELECT):
        ...
        if(feedback.menu_entry_id==1):
            ...
            listener.waitForTransform('/endeff1','/link3',rospy.Time(), rospy.Duration(1.0))
            (trans,rot)=listener.lookupTransform('link3','endeff1',rospy.Time())
            print(trans,rot)
...
if __name__=="__main__":
    ...
    int_marker.header.frame_id = "link3"
    ...
    print(listener.frameExists('endeff1'))
    (trans,rot)=listener.lookupTransform('link3','endeff1',rospy.Time())
    print(trans,rot)
