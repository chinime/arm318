...
void ROBOTHardwareInterface::init() {
   ...
   num_joints_=5;
	...
	joint_names_[0]="joint1";	
	joint_names_[1]="joint3";
	joint_names_[2]="joint4";
	joint_names_[3]="joint5";	
	joint_names_[4]="joint6";
    ...
    joint_position_command_[0]=0.523;
    joint_position_command_[1]=2.094;
    joint_position_command_[2]=1.396;
    joint_position_command_[3]=1.745;
    joint_position_command_[4]=0.174;
...
void ROBOTHardwareInterface::write(ros::Duration elapsed_time) {
	...
	joints_pub.data.push_back(30.0+(angles::to_degrees(joint_position_command_[0])));
	joints_pub.data.push_back(120.0+(angles::to_degrees(joint_position_command_[1])));
	joints_pub.data.push_back(80.0+(angles::to_degrees(joint_position_command_[2])));
	joints_pub.data.push_back(100.0+(angles::to_degrees(joint_position_command_[3])));
	joints_pub.data.push_back(10.0+(angles::to_degrees(joint_position_command_[4])));
